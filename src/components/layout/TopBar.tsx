...
export function TopBar({
    ...
    return (
        <div className="absolute top-[calc(16px+env(safe-area-inset-top))] left-4 right-4 md:left-auto md:right-4 md:w-[520px] z-[5000] flex flex-col gap-2 pointer-events-none">
